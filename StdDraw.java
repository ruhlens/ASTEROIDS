...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    // last draw operation (CS159)
    private static String lastDraw;
    public static String getLastDraw() {
        return lastDraw;
    }
    ...
    public static void line(double x0, double y0, double x1, double y1) {
        ...
        lastDraw = String.format("line(%.1f, %.1f, %.1f, %.1f)", x0, y0, x1, y1);
    }
    ...
    private static void pixel(double x, double y) {
        ...
        lastDraw = String.format("pixel(%.1f, %.1f)", x, y);
    }
    ...
    public static void point(double x, double y) {
        ...
        lastDraw = String.format("point(%.1f, %.1f)", x, y);
    }
    ...
    public static void circle(double x, double y, double radius) {
        ...
        lastDraw = String.format("circle(%.1f, %.1f, %.1f)", x, y, radius);
    }
    ...
    public static void filledCircle(double x, double y, double radius) {
        ...
        lastDraw = String.format("filledCircle(%.1f, %.1f, %.1f)", x, y, radius);
    }
    ...
    public static void ellipse(double x, double y, double semiMajorAxis, double semiMinorAxis) {
        ...
        lastDraw = String.format("ellipse(%.1f, %.1f, %.1f, %.1f)", x, y, semiMajorAxis, semiMinorAxis);
    }
    ...
    public static void filledEllipse(double x, double y, double semiMajorAxis, double semiMinorAxis) {
        ...
        lastDraw = String.format("filledEllipse(%.1f, %.1f, %.1f, %.1f)", x, y, semiMajorAxis, semiMinorAxis);
    }
    ...
    public static void square(double x, double y, double halfLength) {
        ...
        lastDraw = String.format("square(%.1f, %.1f, %.1f)", x, y, halfLength);
    }
    ...
    public static void filledSquare(double x, double y, double halfLength) {
        ...
        lastDraw = String.format("filledSquare(%.1f, %.1f, %.1f)", x, y, halfLength);
    }
    ...
    public static void rectangle(double x, double y, double halfWidth, double halfHeight) {
        ...
        lastDraw = String.format("rectangle(%.1f, %.1f, %.1f, %.1f)", x, y, halfWidth, halfHeight);
    }
    ...
    public static void filledRectangle(double x, double y, double halfWidth, double halfHeight) {
        ...
        lastDraw = String.format("filledRectangle(%.1f, %.1f, %.1f, %.1f)", x, y, halfWidth, halfHeight);
    }
    ...
    public static void polygon(double[] x, double[] y) {
        ...
        lastDraw = String.format("polygon()");
    }
    ...
    public static void filledPolygon(double[] x, double[] y) {
        ...
        lastDraw = String.format("filledPolygon()");
    }
...
*/
    ...
    public static void text(double x, double y, String text) {
        ...
        lastDraw = String.format("text(%.1f, %.1f, %s)", x, y, text);
    }
    ...
    public static void textLeft(double x, double y, String text) {
        ...
        lastDraw = String.format("textLeft(%.1f, %.1f, %s)", x, y, text);
    }
    ...
    public static void textRight(double x, double y, String text) {
        ...
        lastDraw = String.format("textRight(%.1f, %.1f, %s)", x, y, text);
    }
